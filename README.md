...
## Mój projekt to GNS3 Server na Ubuntu Server 22.0.4 z wykorzystaniem security onion jako testowanie interfejsow SPAN w urzadzeniach sieciowych np. CISCO
